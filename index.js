...
// const a = process.env.DB_USER;


const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.q3gzb.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
